...
__DEFINE__(1590717508355, function(require, module, exports) {
...
}, function(modId) {var map = {"./doc-utils":1590717508356,"./traits":1590717508359,"./module-wrapper":1590717508360,"./errors":1590717508357,"./collect-content-types":1590717508361,"./modules/common":1590717508362,"./lexer":1590717508363,"./xml-templater":1590717508364,"./file-type-config":1590717508373,"./xml-matcher":1590717508366}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508356, function(require, module, exports) {
...
}, function(modId) { var map = {"./errors":1590717508357,"./utils":1590717508358}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508357, function(require, module, exports) {
...
}, function(modId) { var map = {"./utils":1590717508358}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508358, function(require, module, exports) {
...
__DEFINE__(1590717508359, function(require, module, exports) {
...
}, function(modId) { var map = {"./doc-utils":1590717508356,"./errors":1590717508357}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508360, function(require, module, exports) {
...
__DEFINE__(1590717508361, function(require, module, exports) {
...
__DEFINE__(1590717508362, function(require, module, exports) {
  ...
  _createClass(Common, [{
    ...
    value: function getFileType(_ref2) {
      ...
      if (invertedContentTypes[docxContentType]) {
        fileType = "docx";
        doc.targets = concatArrays([doc.targets, invertedContentTypes[docxContentType]]);
      }

      if (invertedContentTypes[docxmContentType]) {
        fileType = "docx";
        doc.targets = concatArrays([doc.targets, invertedContentTypes[docxmContentType]]);
      }

      if (invertedContentTypes[dotxContentType]) {
        fileType = "docx";
        doc.targets = concatArrays([doc.targets, invertedContentTypes[dotxContentType]]);
      }

      if (invertedContentTypes[dotmContentType]) {
        fileType = "docx";
        doc.targets = concatArrays([doc.targets, invertedContentTypes[dotmContentType]]);
      }

      if (invertedContentTypes[pptxContentType]) {
        fileType = "pptx";
        doc.targets = concatArrays([doc.targets, invertedContentTypes[pptxContentType]]);
      }
...
}, function(modId) { var map = {"../module-wrapper":1590717508360,"../doc-utils":1590717508356}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508363, function(require, module, exports) {
...
}, function(modId) { var map = {"./errors":1590717508357,"./doc-utils":1590717508356}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508364, function(require, module, exports) {
...
}, function(modId) { var map = {"./doc-utils":1590717508356,"./scope-manager":1590717508365,"./xml-matcher":1590717508366,"./errors":1590717508357,"./lexer":1590717508363,"./parser.js":1590717508367,"./render.js":1590717508369,"./postrender.js":1590717508370,"./resolve.js":1590717508371,"./join-uncorrupt":1590717508372}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508365, function(require, module, exports) {
...
__DEFINE__(1590717508366, function(require, module, exports) {
...
}, function(modId) { var map = {"./doc-utils":1590717508356}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508367, function(require, module, exports) {
      ...
      return modules.reduce(function (postparsed, module) {
        var r = module.postparse(postparsed, _objectSpread({}, options, {
          postparse: function postparse(parsed, opts) {
            return _postparse(parsed, _objectSpread({}, options, {}, opts));
          },
          getTraits: getTraits
        }));
...
}, function(modId) { var map = {"./doc-utils":1590717508356,"./prefix-matcher":1590717508368}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508368, function(require, module, exports) {
...
__DEFINE__(1590717508369, function(require, module, exports) {
...
__DEFINE__(1590717508370, function(require, module, exports) {
...
__DEFINE__(1590717508371, function(require, module, exports) {
...
__DEFINE__(1590717508372, function(require, module, exports) {
...
__DEFINE__(1590717508373, function(require, module, exports) {
...
}, function(modId) { var map = {"./modules/loop":1590717508374,"./modules/space-preserve":1590717508375,"./modules/rawxml":1590717508376,"./modules/expand-pair-trait":1590717508377,"./modules/render":1590717508379}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508374, function(require, module, exports) {
...
}, function(modId) { var map = {"../doc-utils":1590717508356,"../module-wrapper":1590717508360}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508375, function(require, module, exports) {
...
__DEFINE__(1590717508376, function(require, module, exports) {
...
}, function(modId) { var map = {"../traits":1590717508359,"../doc-utils":1590717508356,"../errors":1590717508357,"../module-wrapper":1590717508360}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508377, function(require, module, exports) {
...
}, function(modId) { var map = {"../mergesort":1590717508378,"../doc-utils":1590717508356,"../module-wrapper":1590717508360,"../traits":1590717508359,"../errors":1590717508357}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590717508378, function(require, module, exports) {
...
__DEFINE__(1590717508379, function(require, module, exports) {
...
}, function(modId) { var map = {"../module-wrapper":1590717508360,"../errors":1590717508357,"../doc-utils":1590717508356}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1590717508355);
})()
